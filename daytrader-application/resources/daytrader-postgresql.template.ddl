...
CREATE USER ${config['daytrader.username']!"daytrader"} WITH PASSWORD '${config['daytrader.password']!"br00k11n"}';
CREATE DATABASE ${config['daytrader.dbname']!"daytrader"} OWNER ${config['daytrader.username']!"daytrader"};

\connect ${config['daytrader.dbname']!"daytrader"} ${config['daytrader.username']!"daytrader"};
...
GRANT ALL PRIVILEGES ON DATABASE ${config['daytrader.dbname']!"daytrader"} TO ${config['daytrader.username']!"daytrader"};
